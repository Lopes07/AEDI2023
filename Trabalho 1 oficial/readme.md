...
evento2, onde: evento1 = [começo1, fim1] e evento2 = [começo2, fim2].
Os horários dos eventos são válidos no formato de 24 horas no formato HH:MM.
Um conflito ocorre quando dois eventos têm alguma interseção não vazia (ou seja, algum momento é comum a ambos os eventos).
